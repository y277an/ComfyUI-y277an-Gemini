"""ComfyUI-y277an-Gemini: Google Gemini image / text / TTS / video nodes.
...
except Exception as e:  # keep ComfyUI (and pytest) from hard-crashing on import
    import traceback

    print("[ComfyUI-y277an-Gemini] failed to load nodes:", e)
    traceback.print_exc()
    NODE_CLASS_MAPPINGS = {}
    NODE_DISPLAY_NAME_MAPPINGS = {}
